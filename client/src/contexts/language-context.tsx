...
const translations = {
  en: {
    ...
    'search.matching': 'merchants matching your search',
    'search.tryAdjusting': 'Try adjusting your search terms or browse all merchants below',
  ...
  ar: {
    ...
    'search.merchants': 'تجار',
    'search.showing': 'عرض',
    'search.matching': 'تاجر يطابق بحثك',
    'search.tryAdjusting': 'جرب تعديل مصطلحات البحث أو تصفح جميع التجار أدناه',
