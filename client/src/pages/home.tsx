    ...
    <div className="min-h-screen bg-gray-50 font-inter">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4" data-testid="text-hero-title">
        ...
        {/* Merchants Grid */}
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-8" data-testid="text-featured-merchants">
            Featured Merchants
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" data-testid="grid-merchants">
